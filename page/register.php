...
<body>
  ...
  <div class="auth-container">
    <div class="auth-left">
      ...
      <div class="auth-left-content">
        <div class="auth-quote">"Today a reader, tomorrow a leader."</div>
        <div class="auth-author">— Margaret Fuller</div>
      </div>
    ...
    <div class="auth-right">
      ...
      <h1 class="auth-title">Create Member</h1>
      <p class="auth-subtitle">Join us and start building your library today.</p>
      
      <form action="../actions/auth_signup.php" method="POST">
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input type="password" id="password_confirm" name="password_confirm" placeholder="Repeat your password" minlength="8" required />
            <button type="button" class="eye-btn" onclick="togglePassword('password_confirm', 'eyeIconConfirm')">
              <svg id="eyeIconConfirm" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
            </button>
          </div>
          <span class="helper-text" id="password_match_message">Passwords must match.</span>
        </div>
        
        <button type="submit" class="btn-submit" id="btn-submit">Sign Up</button>
      </form>
  ...
  <script>
    ...
    const match_message = document.getElementById("password_match_message");
    const btn_submit = document.getElementById("btn-submit");

    function validatePassword(){
      if(password.value != confirm_password.value) {
        confirm_password.setCustomValidity("Passwords Don't Match");
        match_message.style.color = "var(--rust)";
        match_message.innerText = "Passwords don't match!";
      } else {
        confirm_password.setCustomValidity('');
        match_message.style.color = "#2b8a3e";
        match_message.innerText = "Passwords match.";
      }
    }
